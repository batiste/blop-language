...
// ============================================================================
// as const — const assertion helpers
// ============================================================================
 ...
 */
function isConstAssertion(typeCastNode) {
 ...
 */
function buildConstType(expNode) {
 ...
 */
function buildConstObjectType(objectLiteralNode) {
 ...
 */
function buildConstArrayType(arrayLiteralNode) {
  const elements = [];
