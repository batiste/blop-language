...
let START_0 = (stream, index) => {
  ...
  if (stream[i].type !== 'EOS') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'START', sub_rule_index: 2,
...
let GLOBAL_STATEMENT_9 = (stream, index) => {
  ...
  const node = {
    children, stream_index: index, name: 'GLOBAL_STATEMENT',
    subRule: 9, type: 'GLOBAL_STATEMENT', named,
  };

  if (stream[i].type !== 'throw') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'GLOBAL_STATEMENT', sub_rule_index: 0,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let SCOPED_STATEMENT_6 = (stream, index) => {
  ...
  if (stream[i].type !== 'return') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'SCOPED_STATEMENT', sub_rule_index: 0,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let assign_0 = (stream, index) => {
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'assign', sub_rule_index: 4,
...
let for_loop_0 = (stream, index) => {
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'for_loop', sub_rule_index: 2,
        sub_rule_stream_index: i - index, sub_rule_token_index: 2,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'in') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'for_loop', sub_rule_index: 3,
        sub_rule_stream_index: i - index, sub_rule_token_index: 3,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'for_loop', sub_rule_index: 6,
  ...
  if (stream[i].type !== '{') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'for_loop', sub_rule_index: 7,
  ...
  if (stream[i].type !== '}') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'for_loop', sub_rule_index: 9,
...
let for_loop_1 = (stream, index) => {
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'for_loop', sub_rule_index: 4,
        sub_rule_stream_index: i - index, sub_rule_token_index: 4,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'name') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'for_loop', sub_rule_index: 5,
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'for_loop', sub_rule_index: 10,
  ...
  if (stream[i].type !== '{') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'for_loop', sub_rule_index: 11,
  ...
  if (stream[i].type !== '}') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'for_loop', sub_rule_index: 13,
...
let func_def_0 = (stream, index) => {
  ...
  if (stream[i].type !== ')') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'func_def', sub_rule_index: 4,
        sub_rule_stream_index: i - index, sub_rule_token_index: 4,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'func_def', sub_rule_index: 6,
        sub_rule_stream_index: i - index, sub_rule_token_index: 6,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let func_def_1 = (stream, index) => {
  ...
  if (stream[i].type !== ')') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'func_def', sub_rule_index: 5,
        sub_rule_stream_index: i - index, sub_rule_token_index: 5,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'func_def', sub_rule_index: 7,
        sub_rule_stream_index: i - index, sub_rule_token_index: 7,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let annotation_0 = (stream, index) => {
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'annotation', sub_rule_index: 1,
        sub_rule_stream_index: i - index, sub_rule_token_index: 1,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'name') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'annotation', sub_rule_index: 2,
        sub_rule_stream_index: i - index, sub_rule_token_index: 2,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let func_def_params_0 = (stream, index) => {
  ...
  if (stream[i].type !== ',') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'func_def_params', sub_rule_index: 4,
        sub_rule_stream_index: i - index, sub_rule_token_index: 4,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'func_def_params', sub_rule_index: 5,
        sub_rule_stream_index: i - index, sub_rule_token_index: 5,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let func_call_0 = (stream, index) => {
  ...
  if (stream[i].type !== ')') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'func_call', sub_rule_index: 3,
        sub_rule_stream_index: i - index, sub_rule_token_index: 3,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let func_body_fat_0 = (stream, index) => {
  ...
  if (stream[i].type !== '}') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'func_body_fat', sub_rule_index: 2,
        sub_rule_stream_index: i - index, sub_rule_token_index: 2,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let func_body_0 = (stream, index) => {
  ...
  if (stream[i].type !== '}') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'func_body', sub_rule_index: 2,
        sub_rule_stream_index: i - index, sub_rule_token_index: 2,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let class_def_0 = (stream, index) => {
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'class_def', sub_rule_index: 2,
        sub_rule_stream_index: i - index, sub_rule_token_index: 2,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'extends') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'class_def', sub_rule_index: 3,
        sub_rule_stream_index: i - index, sub_rule_token_index: 3,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'name') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'class_def', sub_rule_index: 4,
        sub_rule_stream_index: i - index, sub_rule_token_index: 4,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'class_def', sub_rule_index: 5,
        sub_rule_stream_index: i - index, sub_rule_token_index: 5,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '{') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'class_def', sub_rule_index: 6,
        sub_rule_stream_index: i - index, sub_rule_token_index: 6,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '}') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'class_def', sub_rule_index: 8,
...
let class_func_def_0 = (stream, index) => {
  ...
  if (stream[i].type !== '(') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'class_func_def', sub_rule_index: 3,
        sub_rule_stream_index: i - index, sub_rule_token_index: 3,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== ')') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'class_func_def', sub_rule_index: 4,
        sub_rule_stream_index: i - index, sub_rule_token_index: 4,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'class_func_def', sub_rule_index: 6,
        sub_rule_stream_index: i - index, sub_rule_token_index: 6,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let class_func_def_1 = (stream, index) => {
  ...
  if (stream[i].type !== ')') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'class_func_def', sub_rule_index: 5,
        sub_rule_stream_index: i - index, sub_rule_token_index: 5,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'class_func_def', sub_rule_index: 7,
        sub_rule_stream_index: i - index, sub_rule_token_index: 7,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let array_literal_0 = (stream, index) => {
  ...
  if (stream[i].type !== ']') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'array_literal', sub_rule_index: 6,
        sub_rule_stream_index: i - index, sub_rule_token_index: 6,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let array_literal_body_0 = (stream, index) => {
  ...
  if (stream[i].type !== ',') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'array_literal_body', sub_rule_index: 1,
        sub_rule_stream_index: i - index, sub_rule_token_index: 1,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let condition_0 = (stream, index) => {
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'condition', sub_rule_index: 2,
        sub_rule_stream_index: i - index, sub_rule_token_index: 2,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '{') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'condition', sub_rule_index: 3,
        sub_rule_stream_index: i - index, sub_rule_token_index: 3,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '}') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'condition', sub_rule_index: 5,
        sub_rule_stream_index: i - index, sub_rule_token_index: 5,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let else_if_0 = (stream, index) => {
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'else_if', sub_rule_index: 3,
        sub_rule_stream_index: i - index, sub_rule_token_index: 3,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '{') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'else_if', sub_rule_index: 4,
        sub_rule_stream_index: i - index, sub_rule_token_index: 4,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '}') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'else_if', sub_rule_index: 6,
        sub_rule_stream_index: i - index, sub_rule_token_index: 6,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let while_loop_0 = (stream, index) => {
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'while_loop', sub_rule_index: 2,
        sub_rule_stream_index: i - index, sub_rule_token_index: 2,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '{') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'while_loop', sub_rule_index: 3,
        sub_rule_stream_index: i - index, sub_rule_token_index: 3,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '}') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'while_loop', sub_rule_index: 5,
        sub_rule_stream_index: i - index, sub_rule_token_index: 5,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let object_literal_0 = (stream, index) => {
  ...
  if (stream[i].type !== '}') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'object_literal', sub_rule_index: 4,
        sub_rule_stream_index: i - index, sub_rule_token_index: 4,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let object_literal_body_0 = (stream, index) => {
  ...
  if (stream[i].type !== ',') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'object_literal_body', sub_rule_index: 4,
        sub_rule_stream_index: i - index, sub_rule_token_index: 4,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let object_destructuring_0 = (stream, index) => {
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'object_destructuring', sub_rule_index: 1,
        sub_rule_stream_index: i - index, sub_rule_token_index: 1,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '}') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'object_destructuring', sub_rule_index: 4,
        sub_rule_stream_index: i - index, sub_rule_token_index: 4,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let destructuring_values_1 = (stream, index) => {
  ...
  if (stream[i].type !== ',') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'destructuring_values', sub_rule_index: 4,
        sub_rule_stream_index: i - index, sub_rule_token_index: 4,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let import_statement_0 = (stream, index) => {
  ...
  if (stream[i].type !== 'str') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'import_statement', sub_rule_index: 4,
        sub_rule_stream_index: i - index, sub_rule_token_index: 4,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let import_statement_1 = (stream, index) => {
  ...
  if (stream[i].type !== '}') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'import_statement', sub_rule_index: 5,
        sub_rule_stream_index: i - index, sub_rule_token_index: 5,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'import_statement', sub_rule_index: 6,
        sub_rule_stream_index: i - index, sub_rule_token_index: 6,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'from') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'import_statement', sub_rule_index: 7,
        sub_rule_stream_index: i - index, sub_rule_token_index: 7,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'str') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'import_statement', sub_rule_index: 8,
        sub_rule_stream_index: i - index, sub_rule_token_index: 8,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let virtual_node_0 = (stream, index) => {
  ...
  if (stream[i].type !== '/>') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'virtual_node', sub_rule_index: 4,
        sub_rule_stream_index: i - index, sub_rule_token_index: 4,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let virtual_node_1 = (stream, index) => {
  ...
  if (stream[i].type !== '>') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'virtual_node', sub_rule_index: 3,
        sub_rule_stream_index: i - index, sub_rule_token_index: 3,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '</') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'virtual_node', sub_rule_index: 5,
        sub_rule_stream_index: i - index, sub_rule_token_index: 5,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'name') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'virtual_node', sub_rule_index: 6,
        sub_rule_stream_index: i - index, sub_rule_token_index: 6,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '>') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'virtual_node', sub_rule_index: 7,
        sub_rule_stream_index: i - index, sub_rule_token_index: 7,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let virtual_node_exp_0 = (stream, index) => {
  ...
  if (stream[i].type !== '/>') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'virtual_node_exp', sub_rule_index: 4,
        sub_rule_stream_index: i - index, sub_rule_token_index: 4,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let virtual_node_exp_1 = (stream, index) => {
  ...
  if (stream[i].type !== '>') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'virtual_node_exp', sub_rule_index: 3,
        sub_rule_stream_index: i - index, sub_rule_token_index: 3,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '</') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'virtual_node_exp', sub_rule_index: 5,
        sub_rule_stream_index: i - index, sub_rule_token_index: 5,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'name') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'virtual_node_exp', sub_rule_index: 6,
        sub_rule_stream_index: i - index, sub_rule_token_index: 6,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '>') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'virtual_node_exp', sub_rule_index: 7,
        sub_rule_stream_index: i - index, sub_rule_token_index: 7,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let virtual_node_assign_0 = (stream, index) => {
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'virtual_node_assign', sub_rule_index: 1,
        sub_rule_stream_index: i - index, sub_rule_token_index: 1,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let try_catch_0 = (stream, index) => {
  ...
  if (stream[i].type !== '{') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'try_catch', sub_rule_index: 1,
        sub_rule_stream_index: i - index, sub_rule_token_index: 1,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '}') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'try_catch', sub_rule_index: 3,
        sub_rule_stream_index: i - index, sub_rule_token_index: 3,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'try_catch', sub_rule_index: 4,
        sub_rule_stream_index: i - index, sub_rule_token_index: 4,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'catch') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'try_catch', sub_rule_index: 5,
        sub_rule_stream_index: i - index, sub_rule_token_index: 5,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'name') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'try_catch', sub_rule_index: 6,
        sub_rule_stream_index: i - index, sub_rule_token_index: 6,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'try_catch', sub_rule_index: 7,
        sub_rule_stream_index: i - index, sub_rule_token_index: 7,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '{') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'try_catch', sub_rule_index: 8,
        sub_rule_stream_index: i - index, sub_rule_token_index: 8,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '}') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'try_catch', sub_rule_index: 10,
        sub_rule_stream_index: i - index, sub_rule_token_index: 10,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let access_or_operation_0 = (stream, index) => {
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'access_or_operation', sub_rule_index: 1,
        sub_rule_stream_index: i - index, sub_rule_token_index: 1,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let select_expression_0 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'select_expression',
    subRule: 0, type: 'select_expression', named,
  };

  if (stream[i].type !== 'select') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'select_expression', sub_rule_index: 0,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'select_expression', sub_rule_index: 2,
        sub_rule_stream_index: i - index, sub_rule_token_index: 2,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '{') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'select_expression', sub_rule_index: 3,
        sub_rule_stream_index: i - index, sub_rule_token_index: 3,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  children.push(stream[i]); i++;
  let _rule_4 = select_body(stream, i);
  named['bodies'] = [];
  while (_rule_4) {
    named['bodies'].push(_rule_4);
    children.push(_rule_4);
    i = _rule_4.last_index;
    _rule_4 = select_body(stream, i);
  }

  if (stream[i].type !== 'newline') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'select_expression', sub_rule_index: 5,
        sub_rule_stream_index: i - index, sub_rule_token_index: 5,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '}') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'select_expression', sub_rule_index: 8,
        sub_rule_stream_index: i - index, sub_rule_token_index: 8,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
select_expression_0 = memoize('select_expression_0', select_expression_0);


function select_expression(stream, index) {
  return select_expression_0(stream, index);
}
let select_body_0 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'select_body',
    subRule: 0, type: 'select_body', named,
  };

  if (stream[i].type !== 'newline') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'select_body', sub_rule_index: 0,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'select_body', sub_rule_index: 4,
        sub_rule_stream_index: i - index, sub_rule_token_index: 4,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '{') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'select_body', sub_rule_index: 5,
        sub_rule_stream_index: i - index, sub_rule_token_index: 5,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  children.push(stream[i]); i++;
  const _rule_6 = select_inner(stream, i);
  if (!_rule_6) return false;
  named['inner'] = _rule_6;
  children.push(_rule_6);
  i = _rule_6.last_index;
  ...
  if (stream[i].type !== '}') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'select_body', sub_rule_index: 7,
        sub_rule_stream_index: i - index, sub_rule_token_index: 7,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
select_body_0 = memoize('select_body_0', select_body_0);


function select_body(stream, index) {
  return select_body_0(stream, index);
}
let select_inner_0 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'select_inner',
    subRule: 0, type: 'select_inner', named,
  };
  let _rule_0 = SCOPED_STATEMENTS(stream, i);
  named['stats'] = [];
  while (_rule_0) {
    named['stats'].push(_rule_0);
    children.push(_rule_0);
    i = _rule_0.last_index;
    _rule_0 = SCOPED_STATEMENTS(stream, i);
  }
  node.success = i === stream.length; node.last_index = i;
  return node;
};
select_inner_0 = memoize('select_inner_0', select_inner_0);


function select_inner(stream, index) {
  return select_inner_0(stream, index);
}
let short_if_expression_0 = (stream, index) => {
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'short_if_expression', sub_rule_index: 2,
        sub_rule_stream_index: i - index, sub_rule_token_index: 2,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== '=>') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'short_if_expression', sub_rule_index: 3,
        sub_rule_stream_index: i - index, sub_rule_token_index: 3,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'short_if_expression', sub_rule_index: 4,
        sub_rule_stream_index: i - index, sub_rule_token_index: 4,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'short_if_expression', sub_rule_index: 6,
        sub_rule_stream_index: i - index, sub_rule_token_index: 6,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  if (stream[i].type !== 'else') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'short_if_expression', sub_rule_index: 7,
        sub_rule_stream_index: i - index, sub_rule_token_index: 7,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let exp_0 = (stream, index) => {
  ...
  const _rule_0 = select_expression(stream, i);
  if (!_rule_0) return false;
  children.push(_rule_0);
  i = _rule_0.last_index;
  node.success = i === stream.length; node.last_index = i;
...
exp_2 = memoize_left_recur('exp_2', exp_2);
...
let exp_5 = (stream, index) => {
  ...
  if (stream[i].type !== 'number') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'exp', sub_rule_index: 0,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let exp_9 = (stream, index) => {
  ...
  if (stream[i].type !== ')') {
    if (i >= best_failure_index) {
      const failure = {
        rule_name: 'exp', sub_rule_index: 2,
        sub_rule_stream_index: i - index, sub_rule_token_index: 2,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
