...
let for_loop_2 = (stream, index) => {
  ...
  children.push(stream[i]); i++;
  let _rule_11 = SCOPED_STATEMENTS(stream, i);
  while (_rule_11) {
    named['stats'] ? null : named['stats'] = [];
    named['stats'].push(_rule_11);
    children.push(_rule_11);
    i = _rule_11.last_index;
    _rule_11 = SCOPED_STATEMENTS(stream, i);
  }
  ...
  if (stream[i].type !== '}') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'for_loop', sub_rule_index: 2,
        sub_rule_stream_index: i - index, sub_rule_token_index: 12,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
    }
...
let type_primary_4 = (stream, index) => {
  ...
  if (stream[i].type !== '<') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'type_primary', sub_rule_index: 4,
        sub_rule_stream_index: i - index, sub_rule_token_index: 1,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let object_access_0 = (stream, index) => {
  ...
  const node = {
    ...
    sub_rule_index: 0, type: 'object_access', named,
  };

  if (stream[i].type !== 'optional_chain') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'object_access', sub_rule_index: 0,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let object_access_1 = (stream, index) => {
  ...
  const node = {
    children, stream_index: index, name: 'object_access',
    sub_rule_index: 1, type: 'object_access', named,
  };

  if (stream[i].type !== '.') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'object_access', sub_rule_index: 1,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let object_access_2 = (stream, index) => {
  ...
  const node = {
    children, stream_index: index, name: 'object_access',
    sub_rule_index: 2, type: 'object_access', named,
  };

  if (stream[i].type !== 'optional_chain') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'object_access', sub_rule_index: 2,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  children.push(stream[i]); i++;
  const _rule_4 = object_access(stream, i);
  if (_rule_4) {
    children.push(_rule_4);
    i = _rule_4.last_index;
  }
...
let object_access_3 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
...
object_access_3 = memoize('object_access_3', object_access_3);


let object_access_4 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
...
let operation_0 = (stream, index) => {
  ...
  const node = {
    ...
    sub_rule_index: 0, type: 'operation', named,
  };

  if (stream[i].type !== 'nullish') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'operation', sub_rule_index: 0,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let operation_1 = (stream, index) => {
  ...
  const node = {
    children, stream_index: index, name: 'operation',
    sub_rule_index: 1, type: 'operation', named,
  };

  if (stream[i].type !== 'math_operator') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'operation', sub_rule_index: 1,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let operation_2 = (stream, index) => {
  ...
  const node = {
    children, stream_index: index, name: 'operation',
    sub_rule_index: 2, type: 'operation', named,
  };

  if (stream[i].type !== 'boolean_operator') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'operation', sub_rule_index: 2,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let operation_3 = (stream, index) => {
  ...
  const node = {
    children, stream_index: index, name: 'operation',
    sub_rule_index: 3, type: 'operation', named,
  };

  if (stream[i].type !== '<') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'operation', sub_rule_index: 3,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let operation_4 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'operation',
    sub_rule_index: 4, type: 'operation', named,
  };

  if (stream[i].type !== '>') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'operation', sub_rule_index: 4,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
operation_4 = memoize('operation_4', operation_4);
...
let access_or_operation_0 = (stream, index) => {
  ...
  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'access_or_operation', sub_rule_index: 0,
        sub_rule_stream_index: i - index, sub_rule_token_index: 1,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let access_or_operation_1 = (stream, index) => {
  ...
  const node = {
    children, stream_index: index, name: 'access_or_operation',
    sub_rule_index: 1, type: 'access_or_operation', named,
  };
  const _rule_0 = object_access(stream, i);
  if (!_rule_0) return false;
  named['access'] = _rule_0;
...
let access_or_operation_2 = (stream, index) => {
  ...
  const node = {
    children, stream_index: index, name: 'access_or_operation',
    sub_rule_index: 2, type: 'access_or_operation', named,
  };

  if (stream[i].type !== 'w') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'access_or_operation', sub_rule_index: 2,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let name_exp_1 = (stream, index) => {
  ...
  const node = {
    children, stream_index: index, name: 'name_exp',
    sub_rule_index: 1, type: 'name_exp', named,
  };

  if (stream[i].type !== 'name') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'name_exp', sub_rule_index: 1,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
