...
let assign_3 = (stream, index) => {
  ...
  const _rule_0 = array_destructuring(stream, i);
  if (!_rule_0) return false;
  named['array_destructuring'] = _rule_0;
  children.push(_rule_0);
  i = _rule_0.last_index;
  const _rule_1 = annotation(stream, i);
  if (_rule_1) {
...
let assign_4 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'assign',
    sub_rule_index: 4, type: 'assign', named,
  };
  const _rule_0 = exp(stream, i);
  if (!_rule_0) return false;
  named['path'] = _rule_0;
...
assign_4 = memoize('assign_4', assign_4);
...
let type_primary_5 = (stream, index) => {
  ...
  const _rule_0 = mapped_type(stream, i);
  if (!_rule_0) return false;
  named['mapped'] = _rule_0;
  children.push(_rule_0);
  i = _rule_0.last_index;
  node.success = i === stream.length; node.last_index = i;
  return node;
...
let type_primary_11 = (stream, index) => {
  ...
  if (stream[i].type !== '.') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'type_primary', sub_rule_index: 11,
        sub_rule_stream_index: i - index, sub_rule_token_index: 1,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
let type_primary_12 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'type_primary',
    sub_rule_index: 12, type: 'type_primary', named,
  };
  const _rule_0 = type_name(stream, i);
  if (!_rule_0) return false;
  named['name'] = _rule_0;
  ...
  if (stream[i].type !== '[') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'type_primary', sub_rule_index: 12,
        sub_rule_stream_index: i - index, sub_rule_token_index: 1,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
type_primary_12 = memoize('type_primary_12', type_primary_12);


let type_primary_13 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'type_primary',
    sub_rule_index: 13, type: 'type_primary', named,
  };
  const _rule_0 = type_name(stream, i);
  if (!_rule_0) return false;
  named['name'] = _rule_0;
  ...
  if (stream[i].type !== '[') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'type_primary', sub_rule_index: 13,
        sub_rule_stream_index: i - index, sub_rule_token_index: 1,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
type_primary_13 = memoize('type_primary_13', type_primary_13);


let type_primary_14 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'type_primary',
    sub_rule_index: 14, type: 'type_primary', named,
  };
  const _rule_0 = type_name(stream, i);
  if (!_rule_0) return false;
  named['name'] = _rule_0;
...
type_primary_14 = memoize('type_primary_14', type_primary_14);
...
function type_primary(stream, index) {
  return type_primary_0(stream, index)
    ...
    || type_primary_12(stream, index)
    || type_primary_13(stream, index)
    || type_primary_14(stream, index);
}
...
let mapped_type_0 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'mapped_type',
    sub_rule_index: 0, type: 'mapped_type', named,
  };

  if (stream[i].type !== '{') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'mapped_type', sub_rule_index: 0,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  children.push(stream[i]); i++;
  const _rule_8 = type_expression(stream, i);
  if (!_rule_8) return false;
  named['source'] = _rule_8;
  children.push(_rule_8);
  i = _rule_8.last_index;
  ...
  const _rule_13 = type_expression(stream, i);
  if (!_rule_13) return false;
  named['value'] = _rule_13;
  children.push(_rule_13);
  i = _rule_13.last_index;
  const _rule_14 = single_space_or_newline(stream, i);
  if (!_rule_14) return false;
  children.push(_rule_14);
  i = _rule_14.last_index;

  if (stream[i].type !== '}') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'mapped_type', sub_rule_index: 0,
        sub_rule_stream_index: i - index, sub_rule_token_index: 15,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
    }
...
mapped_type_0 = memoize('mapped_type_0', mapped_type_0);


let mapped_type_1 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'mapped_type',
    sub_rule_index: 1, type: 'mapped_type', named,
  };

  if (stream[i].type !== '{') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'mapped_type', sub_rule_index: 1,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  const _rule_11 = type_expression(stream, i);
  if (!_rule_11) return false;
  named['value'] = _rule_11;
  children.push(_rule_11);
  i = _rule_11.last_index;
  const _rule_12 = single_space_or_newline(stream, i);
...
mapped_type_1 = memoize('mapped_type_1', mapped_type_1);


function mapped_type(stream, index) {
  return mapped_type_0(stream, index)
    || mapped_type_1(stream, index);
}
...
let object_type_property_2 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'object_type_property',
    sub_rule_index: 2, type: 'object_type_property', named,
  };

  if (stream[i].type !== 'readonly') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'object_type_property', sub_rule_index: 2,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
object_type_property_2 = memoize('object_type_property_2', object_type_property_2);


let object_type_property_3 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'object_type_property',
    sub_rule_index: 3, type: 'object_type_property', named,
  };

  if (stream[i].type !== 'name') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'object_type_property', sub_rule_index: 3,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
object_type_property_3 = memoize('object_type_property_3', object_type_property_3);


let object_type_property_4 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'object_type_property',
    sub_rule_index: 4, type: 'object_type_property', named,
  };

  if (stream[i].type !== 'name') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'object_type_property', sub_rule_index: 4,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
object_type_property_4 = memoize('object_type_property_4', object_type_property_4);


function object_type_property(stream, index) {
  return object_type_property_0(stream, index)
    || object_type_property_1(stream, index)
    || object_type_property_2(stream, index)
    || object_type_property_3(stream, index)
    || object_type_property_4(stream, index);
}
...
let class_member_def_1 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'class_member_def',
    sub_rule_index: 1, type: 'class_member_def', named,
  };

  if (stream[i].type !== 'name') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'class_member_def', sub_rule_index: 1,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
class_member_def_1 = memoize('class_member_def_1', class_member_def_1);


function class_member_def(stream, index) {
  return class_member_def_0(stream, index)
    || class_member_def_1(stream, index);
}
...
let array_destructuring_0 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'array_destructuring',
    sub_rule_index: 0, type: 'array_destructuring', named,
  };

  if (stream[i].type !== '[') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'array_destructuring', sub_rule_index: 0,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  const _rule_3 = array_destructuring_values(stream, i);
  if (!_rule_3) return false;
  named['values'] = _rule_3;
  children.push(_rule_3);
  i = _rule_3.last_index;
  if (stream[i].type === 'newline') {
    children.push(stream[i]); i++;
...
array_destructuring_0 = memoize('array_destructuring_0', array_destructuring_0);


function array_destructuring(stream, index) {
  return array_destructuring_0(stream, index);
}
let array_destructuring_values_0 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'array_destructuring_values',
    sub_rule_index: 0, type: 'array_destructuring_values', named,
  };

  if (stream[i].type !== 'name') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'array_destructuring_values', sub_rule_index: 0,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
  ...
  children.push(_rule_3);
  i = _rule_3.last_index;
  const _rule_4 = array_destructuring_values(stream, i);
  if (!_rule_4) return false;
  named['more'] = _rule_4;
  children.push(_rule_4);
  i = _rule_4.last_index;
...
array_destructuring_values_0 = memoize('array_destructuring_values_0', array_destructuring_values_0);


let array_destructuring_values_1 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'array_destructuring_values',
    sub_rule_index: 1, type: 'array_destructuring_values', named,
  };

  if (stream[i].type !== 'name') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'array_destructuring_values', sub_rule_index: 1,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
array_destructuring_values_1 = memoize('array_destructuring_values_1', array_destructuring_values_1);


let array_destructuring_values_2 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'array_destructuring_values',
    sub_rule_index: 2, type: 'array_destructuring_values', named,
  };

  if (stream[i].type !== 'name') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'array_destructuring_values', sub_rule_index: 2,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
array_destructuring_values_2 = memoize('array_destructuring_values_2', array_destructuring_values_2);


let array_destructuring_values_3 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'array_destructuring_values',
    sub_rule_index: 3, type: 'array_destructuring_values', named,
  };

  if (stream[i].type !== 'name') {
    if (i >= best_failure_index) {
      const failure = {
        type: 'array_destructuring_values', sub_rule_index: 3,
        sub_rule_stream_index: i - index, sub_rule_token_index: 0,
        stream_index: i, token: stream[i], first_token: stream[index], success: false,
      };
      record_failure(failure, i);
...
array_destructuring_values_3 = memoize('array_destructuring_values_3', array_destructuring_values_3);


function array_destructuring_values(stream, index) {
  return array_destructuring_values_0(stream, index)
    || array_destructuring_values_1(stream, index)
    || array_destructuring_values_2(stream, index)
    || array_destructuring_values_3(stream, index);
}
...
let exp_37 = (stream, index) => {
  let i = index;
  const children = [];
  const named = {};
  const node = {
    children, stream_index: index, name: 'exp',
    sub_rule_index: 37, type: 'exp', named,
  };
...
function _tokenize(tokenDef, input, char, stream) {
  ...
  if (input.substr(char, 10) === 'satisfies ') {
    return ['satisfies ', 'satisfies'];
  }
  ...
  if (input.substr(char, 9) === 'readonly ') {
